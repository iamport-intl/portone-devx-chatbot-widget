...
const prompts = [
  ...
  "Remember to always refer to the official PortOne documentation for the most accurate and up-to-date information. These questions are a starting point to guide your exploration.",
